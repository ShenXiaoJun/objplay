...
public final class ExecutionGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.google.devtools.remoteexecution.v1test.ExecuteRequest,
      ...
      io.grpc.MethodDescriptor.create(
          ...
          io.grpc.protobuf.ProtoUtils.marshaller(com.google.devtools.remoteexecution.v1test.ExecuteRequest.getDefaultInstance()),
  ...
  private static final class ExecutionDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
      ...
      synchronized (ExecutionGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new ExecutionDescriptorSupplier())
